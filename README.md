...
首先，你需要一个AI agent客户端，如果你听都没听过这个词，那么你就下载腾讯"workbuddy"就好了，记得安装在C盘以外的盘
...
如有新的问题可以联络我的小红书私讯。如果你成功使用起来了，记得在项目页面给我star⭐（就是点击右边那个星星图标）

## 09.21装了这个到底有啥用？（人话版）

法学uu，你也想大二就发表论文吗？显然，你的专业水平和跨学科水平还不够结实，所以你不管是课堂作业还是自创，都在大量用deepseek水。但是，这些AI真是太蠢了，总是虚构法律事实，搞错法律条文，弄乱参考文献——明明你已经把原始素材发给它看了。

所以本项目scholarrelay，以及一众其他项目（称为“skill”）的功能就是给AI一个“培训手册”，让它工作之前自己先背诵工作方法和工作要点。

**本项目scholarrelay，主要解决以下问题：**

1.规定了速度更快的pdf格式文献的解析方法（因为知网下载下来是pdf），防止AI每次都要重新想。

2.规定了更加适合本科生发论文的AI选题，让你的选题方向尽量小而美，尝试跨学科方法，避开与法学大佬直接交锋。

3.规定了更加简单的人机协同文献查询方法。也就是AI根据选题和写作大纲，为你提供关键词，你登陆自己学校的ip在知网搜文献，然后全选搜索结果导出refworks格式题录，AI帮你快速选择文献，然后反馈给你需要的部分，你再下载给它。（听起来完全还是人在做啊？？？！）（废话，因为让AI AGENT学会登录你的学号，再登录你学校ip下的cnki，这种脚本需要定制，你根本搞不定，我也搞不定）

4.规定了更为严格的文献阅读。AI不可能把一百多篇CSSCI文献都每个字读过去，那样我们的上下文就爆炸了。所以它会读完一篇就做一个读书笔记，在需要的时候先看读书笔记，再按图索骥引用原文内容。（但是不用skill的话，它就会偷懒不去看原文！）

5.规定了更为严格的写作手法。AI非常喜欢“防御式论证”（说车轱辘话）和过于华丽的辞藻，这不是我们法学专业的风格，我们最好一个论述说一次就可以了。本项目结合了其他写作skill，尝试避免这一点。

6.规定了更有通用性的word文档排版思路。排版出来的word更加接近于出品（但是，由于python操控word存在局限性，交叉引用的环节只能做标注，实际引用还需要人工操作，但是简单多了）
